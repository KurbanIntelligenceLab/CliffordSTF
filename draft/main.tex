...
On rMD17 at a matched $10^6$-parameter budget across ten molecules, CliffordSTF raises aggregate force-cosine similarity from $0.055$ (base Clifford) to $0.551$, an order-of-magnitude relative directional gain, while improving force MAE from $20.9$ to $17.6$\,meV/\AA{} and aggregate energy MAE from $34.1$ to $30.4$\,meV. CliffordSTF outperforms every CG-free competitor at matched budget---MACE-$L{=}2$ ($0.15$), ICTP-$L{=}2$ ($0.17$), GotenNet ($0.03$), FAENet ($0.14$)---narrowing the absolute gap to spherical-harmonic architectures (EquiformerV2 attains $0.96$ at $L{=}4$). A controlled twelve-variant ablation isolates each track's contribution: a Clifford-only configuration reaches $0.030$, an STF-only configuration reaches $0.097$, and only the hybrid attains $0.506$, evidencing that the two lineages are empirically complementary. On OC22 S2EF, CliffordSTF attains the best out-of-distribution energy MAE in the study ($5.08$ vs $5.26$\,eV for EquiformerV2 and $7.20$\,eV for GotenNet) and the best in-distribution energy MAE ($2.87$\,eV, tied with the base Clifford architecture and $0.5$\,eV ahead of EquiformerV2 at $3.37$\,eV). On OC22 IS2RE, CliffordSTF is the best $L\!\geq\!2$ architecture on in-distribution energy MAE ($4.09$ vs $4.90$\,eV for EquiformerV2 at $L{=}4$; PaiNN, an $L\!=\!1$ vector model, attains the lowest overall at $3.52$\,eV) and on out-of-distribution EwT ($0.31$ vs $0.23$ for EquiformerV2). On out-of-distribution energy MAE, CliffordSTF matches EquiformerV2 within seed variance ($6.46$ vs $6.62$\,eV); GotenNet leads at $5.77$\,eV.
\end{abstract}
